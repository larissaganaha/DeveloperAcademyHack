...
class TestFirebaseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let app1 = Appointment(id: UUID().uuidString, pacient: pac1, scheduledTime: formatter.date(from: "2018/12/08")!, transcript: "", sinptomLog: DataLog(date: Date(), images: ["https://i1.wp.com/aguidaequesabe.com/wp-content/uploads/2010/11/Hives1.jpg?resize=337%2C308", "https://www.fotosantesedepois.com/wp-content/uploads/2014/07/Sintomas-de-Alergia-ao-Sol.jpg"], texts: ["Alergia no braço"]), reportLog: DataLog(date: Date(), images: ["https://i.imgur.com/Ju7VXkh.jpg"], texts: ["Laudo médico de exame alergia"]))
        appointmentService.saveAppointment(app1)
        
        let app2 = Appointment(id: UUID().uuidString, pacient: pac2, scheduledTime: formatter.date(from: "2040/01/03")!, transcript: "", sinptomLog: DataLog(date: Date(), images: ["https://tudoela.com/wp-content/uploads/2018/04/hematoma-subungueal-2.jpg"], texts: ["Pé"]), reportLog: DataLog(date: Date(), images: [], texts: []))
        appointmentService.saveAppointment(app2)
        
        let app3 = Appointment(id: UUID().uuidString, pacient: pac3, scheduledTime: formatter.date(from: "2018/10/31")!, transcript: "", sinptomLog: DataLog(date: Date(), images: ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAKgGbsQgecyzYkIH8NcLUvyqA3oimI72vaJ0_hlzGl681MEo1", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDxrcI047WppuCObeTgOG1ACMNOlXstAgzgCbAFvRAFuj_cDek"], texts: ["Pintas estranhas na pele"]), reportLog: DataLog(date: Date(), images: ["https://i.imgur.com/Ju7VXkh.jpg"], texts: [""]))

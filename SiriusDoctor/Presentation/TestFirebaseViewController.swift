...
class TestFirebaseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let pac1 = Pacient(ID: "156059", name: "JoanazzzZZz Maria", address: "Rua Roxo Moreira, 157 - Cidade Universitária", telephone: "+55 (13) 99643-2967", imageURL: "https://scontent.frao1-2.fna.fbcdn.net/v/t1.0-9/35973177_2086993534706379_3604259674888601600_o.jpg?_nc_cat=0&oh=270eb268ba6807c64da69c399258bf9d&oe=5C323611", bornDate: formatter.date(from: "1990/10/08")!, height: 1.59, weight: 55.0, drink: true, hipertension: false, diabetes: false, smoking: true)
        pacientService.savePacient(pac1)
        
        let pac2 = Pacient(ID: "164923", name: "Carlows Figueiredo", address: "Av Paulista, 1000", telephone: "+55 (11) 99176-8970", imageURL: nil, bornDate: formatter.date(from: "1983/06/08")!, height: 1.77, weight: 90.0, drink: true, hipertension: true, diabetes: false, smoking: true)
        ...
        let app2 = Appointment(id: UUID().uuidString, pacient: pac2, scheduledTime: formatter.date(from: "2040/01/03")!, transcript: "", sinptomLog: DataLog(date: Date(), images: ["http://s2.glbimg.com/3DqkyxE0mubo8zZ3wGZ6bOuGMtUuhCfE-UePrWhWJXoeFijuJJyy22W7__T6PeaS/s.glbimg.com/es/ge/f/original/2012/10/04/pe_da_mayara.jpg", "http://4.bp.blogspot.com/-rXmxiV3Y8BY/VaFdGQ84reI/AAAAAAAADB0/IYpe8iGZ8K0/s1600/11693208_1018902954796060_33698806_n.jpg"], texts: ["bati o pé gente olha que horror!"]), reportLog: DataLog(date: Date(), images: [], texts: []))

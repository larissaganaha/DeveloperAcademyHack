...
class Appointment: PersistenceObject {
    ...
    init (id: String, pacient: Pacient, scheduledTime: Date, transcript: String, sinptomLog: DataLog?, reportLog: DataLog?) {
        ...
        self.dictInfo = [
            ...
            "bornDate": pacient.bornDate.toString(dateFormat: "yyyy/MM/dd"),
            ...
            "scheduledTime": scheduledTime.toString(dateFormat: "yyyy/MM/dd HH:mm"),
        ...
        if let sinptomLog = sinptomLog {
            self.dictInfo["dateSinp"] = sinptomLog.date.toString(dateFormat: "yyyy/MM/dd HH:mm")
            self.dictInfo["imagesSinp"] = sinptomLog.images
            self.dictInfo["textsSinp"] = sinptomLog.texts
        }
        
        if let reportLog = reportLog {
            self.dictInfo["dateReport"] = reportLog.date.toString(dateFormat: "yyyy/MM/dd HH:mm")

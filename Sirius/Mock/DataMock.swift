...
class DataMock {
    ...
    static var appointments: [Appointment] = [
        Appointment(pacient: pacient, scheduledTime: Date(timeIntervalSinceNow: 5000), transcript: "", sinptomLog: DataLog(date: Date(), images: ["https://static.tuasaude.com/media/article/vm/bm/alergia-a-agua_28080_l.jpg", "https://static.tuasaude.com/media/article/aa/db/alergia-na-pele_15424_l.jpg", "https://www.fotosantesedepois.com/wp-content/uploads/2014/07/Sintomas-de-Alergia-ao-Sol.jpg", "https://www.saludconsultas.com/wp-content/uploads/2018/03/Alergias-avicolas.jpg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnQzUOocKwaE7B8H9Gv4QxC4xMuwtcVyjmIThnLwSS06LF6oJk"], texts: ["dor de cabeça", "dor de estômago", "coceira intermitente"]), reportLog: DataLog(date: Date(), images: ["https://i.imgur.com/Ju7VXkh.jpg"], texts: [])),
